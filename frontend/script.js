...
// Backend URL - this will be your Render service URL
const BACKEND_URL = 'https://your-render-service.onrender.com'; // Update this with your actual Render URL
...
async function requestCalculate(payload) {
  try {
    // Try to connect to the Render backend
